...
public class Yb17StringBielder {
    public static void main(String[] args) {
                //StringBuilder create etme -> Decleration
        //capacity()
        //ilk deger atamadan önce 16
        //Deger atandiktan sonra (deger + ilk kapasite) ="Söz" (3+16=19)
        //16 kati asildiginda yani 32 formul ===> kapasite = 16*2+2---> 34 ---> 34*2+2=70---> 70*2+2=142 gibi
                //1.yol
